...
namespace RelationalGit.Recommendation
{
    public class RealityRecommendationStrategy : RecommendationStrategy
    {
        ...
        {
            return new Simulation.PullRequestRecommendationResult(pullRequestContext.ActualReviewers, Array.Empty<DeveloperKnowledge>(),null,null,pullRequestContext.ComputeDefectPronenessScore(),pullRequestContext.ComputeMaxExpertise(pullRequestContext.ActualReviewers), pullRequestContext.PullRequest.Number);
        }
    }
}
